...
batch_size = 100 #### 100 images at ones 
	...
	with tf.Session() as sess:
		...
		for epoch in hm_epochs:
			...
			for _ in range(int(mnist.train.num_examples/batch_size)):
				epx, epoch_y = mnist.train.next_batch(batch_size)

				_, c = sess.run([optimizer, cost], feed_dict={x: epx, y:epoch_y})
				epoch_loss += c 
